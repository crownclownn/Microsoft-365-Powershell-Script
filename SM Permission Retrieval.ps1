...
$sharedMailboxes = Get-Content "C:\Temp\Username\Script\Shared mailbox permission\Sharemailbox.txt"
$report = @()
...
$report | Export-Csv "C:\Temp\Username\Script\Shared mailbox permission\SharedMailboxPermissionsretrieve.csv"